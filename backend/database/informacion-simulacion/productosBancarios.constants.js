const PRODUCTOS_BANCARIOS = {
  ...
  'Cuenta Corriente': {
    categoria: 'Captacion',
    concepto:
      'Producto de deposito a la vista que permite manejar cheques y realizar operaciones con mayor flexibilidad.',
    caracteristicas: [
      'Chequera asociada',
  ...
  'CDT Digital': {
    ...
    caracteristicas: ['Plazos de 30 a 540 dias', 'Tasa fija garantizada', 'Apertura 100% en linea'],
    beneficios: [
      'Inversion segura y protegida por Fogafin',
      'Sin cobros adicionales',
      'Intereses pagados segun eleccion del cliente',
    ],
    requisitos: ['Mayor de edad', 'Cuenta en el banco', 'Monto minimo 100000'],
  },
  'Credito de Libre Inversion': {
    ...
    requisitos: ['Mayor de 21 anos', 'Historial crediticio positivo', 'Soporte de ingresos'],
  },
  'Credito Educativo EducaPlus': {
    ...
    requisitos: ['Documento de identidad', 'Soporte de matricula', 'Ingresos demostrables'],
  },
  'Credito Rotativo Empresarial': {
    categoria: 'Colocacion',
    concepto:
      'Linea de credito flexible para personas naturales con actividad empresarial o pymes.',
    caracteristicas: [
